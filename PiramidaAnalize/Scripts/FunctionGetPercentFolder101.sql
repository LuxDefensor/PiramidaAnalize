...
/****** Object:  UserDefinedFunction [dbo].[GetPercentFolder101]    Script Date: 06/07/2016 07:27:12 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE FUNCTION [dbo].[GetPercentFolder101]
(
...
BEGIN
	...
	SELECT @Expected=@Items * DATEDIFF(Y,@DateStart,@DateEnd + 1)
	...
	BEGIN
		...
		BEGIN
			...
			WHERE PARNUMBER=101 and OBJECT=@DevCode
